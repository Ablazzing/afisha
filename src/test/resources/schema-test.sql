...
create table if not exists application.event_type (id serial primary key, name varchar(100) NOT NULL UNIQUE);
--Заполнение таблицы тип событий
insert into application.event_type (name) values ('museum'), ('cinema'), ('theatre') ON CONFLICT DO NOTHING;
